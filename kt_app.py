...
def main():
    ...
    #for a wall
    brw = (gd/3) + (gd*m.cos(wall_azimuth_angle)) + (gd/10)*m.cos(m.radians(360*(julian_day - 172)/365))
    ...
    if st.button('Results'):
        ...
        table2_data = {
            "Variable": ["Extra Terrestrial Solar Insolation", "Clear Sky Radiation","Beam Radiation", "Diffused Radiation",'Beam Radiation on a wall','Total Radiation on a wall'],
            "Value": [p, gd,br, dr,brw,trw]
        }
